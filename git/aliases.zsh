...
alias gst='log_and_run_command git stash push'
alias gstp='log_and_run_command git stash pop'
alias gsta='log_and_run_command git stash apply'
alias gstl='log_and_run_command git stash list'
alias gstlp='log_and_run_command git stash list -p'

alias grb='log_and_run_command git rebase'
alias grbm='log_and_run_command git rebase $(git-primary-branch-name)'
alias grbi='log_and_run_command git rebase -i'
alias grbim='log_and_run_command git rebase -i $(git-primary-branch-name)'
alias grbc='log_and_run_command git rebase --continue'
